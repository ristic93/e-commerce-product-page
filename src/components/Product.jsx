        ...
        <div className="hidden lg:flex justify-between max-w-xl">
          {products.map((item, idx) => {
            return (
              ...
              >
                <img
                  className={`${idx === value && "border-orange opacity-40"} w-full cursor-pointer rounded-xl ease-in-out duration-700 hover:scale-125 hover:opacity-50`}
                  src={item.thumbnail}
                  alt="product-photo"
                />
              </div>
      ...
      <article className="py-[40px] px-10">
        ...
        <div className="mt-10 lg:flex items-center justify-between gap-2">
          <ul className="flex items-center justify-between bg-lightGrayishBlue py-2 px-4 rounded shadow lg:flex-1">
            ...
            >
              <img src={minus} alt="" className="hover:scale-[1.4]"/>
            </li>
            ...
            <li
              ...
              className="hover:opacity-60 cursor-pointer"
            >
              <img src={plus} alt="" className="hover:scale-[1.4]"/>
            </li>
          </ul>
